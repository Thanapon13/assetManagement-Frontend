                ...
                <div
                  ...
                  className={`${
                    item.repairStatus === 'waitTechnicianConfirm'
                      ...
                      ? 'bg-yellow-300 text-yellow-700 border-yellow-300 rounded-xl'
                      : item.repairStatus === 'waitApprove'
                      ? ' bg-purple-600 border-purple-600 text-white rounded-xl'
                      : item.repairStatus === 'draftRepair'
                      ? ' bg-gray-300 border-gray-300 text-black rounded-xl'
                      : item.repairStatus === 'done'
                      ? 'bg-sidebar-green text-text-green  rounded-xl border-sidebar-green '
                      : 'bg-red-200 text-red-600 rounded-xl border-red-200'
