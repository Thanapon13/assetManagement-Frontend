      ...
      <div className="bg-white border-[1px] p-4 rounded-lg shadow-sm text-sm mt-5">
        <div className="flex justify-between">
          ...
          <Link
            to="repairDetail"
            // state={{ data: item }}
            className="border-[1px] gap-2 border-text-green  focus:border-transparent shadow-sm text-sm font-medium  text-text-green  hover:bg-sidebar-green focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-800  px-2 flex justify-center items-center rounded-md"
          >
            <BsFillEyeFill className="w-[16px] h-[16px] text-text-green" />
            <h1>ดูประวัติของครุภัณฑ์นี้</h1>
          </Link>
        </div>
        ...
        <div className="overflow-x-auto scrollbar pt-4">
          <div className="w-[1000px] lg:w-full p-2">
            ...
            <div className="scrollbar max-h-[45vh] overflow-y-auto">
              {data.informRepairManArray?.map((ele, idx) => {
                return (
                  <div className="grid grid-cols-7 gap-2 text-center">
