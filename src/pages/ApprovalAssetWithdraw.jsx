...
// import { WithdrawApprovedListItem, WithdrawApproveListItem } from '../components/listItem/'
import  WithdrawApproveListItem  from '../components/listItem/WithdrawApproveListItem'
import  WithdrawApprovedListItem from '../components/listItem/WithdrawApprovedListItem'

const ApprovalAssetWithdraw = () => {
  ...
  return (
    <>
      ...
      <div className="bg-background-page pt-5 p-3 w-[100vw] sm:w-[85vw] ">
        {/* Header */}
        <div className="text-2xl text-text-green ">อนุมัติเบิกจ่ายครุภัณฑ์</div>
        <div className="flex pt-3">
          ...
          <div className="flex text-xs">
            ...
            <div className="text-text-gray ml-2">อนุมัติเบิกจ่าย</div>
          </div>
        </div>
        ...
        <div className="bg-white border-[1px] p-4 rounded-lg shadow-sm text-sm mt-5">
          ...
          {/* status */}
          <div className="grid sm:grid-cols-2 gap-5 md:grid-cols-4 pt-5 md:gap-10 xl:gap-20 p-2">
          ...
          {/* header approve list */}
          <div className="flex flex-col gap-5 sm:flex-row sm:justify-between mt-5 pt-5 border-t-2">
          ...
          {/* approve list item */}
          <WithdrawApproveListItem data={dataApproveList} />
        </div>
        {/* รายการคำขอที่จัดการแล้ว */}
        <div className="bg-white border-[1px] mb-5 p-4 rounded-lg shadow-sm text-sm mt-3">
          {/* header */}
          <div className="flex flex-col sm:flex-row gap-y-3 space-x-10">
          ...
          {/* approved list item */}
          <WithdrawApprovedListItem data={dataApprovedList} />
        </div>
      </div>
      {/* footer */}
...
export default ApprovalAssetWithdraw
