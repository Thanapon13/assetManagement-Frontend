...
function Modal({
  ...
  return (
    ...
    >
      ...
      <div className={`md:w-${width ? width : "[700px]"} w-[100%] h-[700px] mx-auto`}>
        <div className="bg-white  rounded">
          <div className="flex justify-between border-b-2 border-grey-300  p-4">
            ...
            <div className="flex justify-center items-center text-xs mr-3">
              ...
              <div className="text-text-green font-bold bg-sidebar-green px-8 py-2 rounded-full">ใช้งานปกติ</div>
            </div>
            <button
