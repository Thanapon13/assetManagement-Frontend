 const WithdrawApprovedListItem = (props) => {
  return (
    <>
      {props.data.map((item, idx) => {
        return (
          <div key={idx} className="bg-background-page border-[2px] rounded-md mt-5 p-3 w-full">
...
export default WithdrawApprovedListItem
