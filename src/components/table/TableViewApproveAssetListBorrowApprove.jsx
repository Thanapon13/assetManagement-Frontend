...
const TableViewApproveAssetListBorrowApprove = ({ approveAssetList }) => {
  ...
  return (
    <>
      {approveAssetList.map((item, idx) => {
        return (
          <div className="grid grid-cols-9 gap-2 h-12 pt-2 text-xs text-center items-center bg-white">
...
export default TableViewApproveAssetListBorrowApprove;
